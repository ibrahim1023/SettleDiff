...
|---|---|---|
| Hyperfusion endpoint and model ID | Select a tool-capable model only after the unpaid compatibility contract passes; keep both values in environment configuration. | Implementation Task 8 |
